...
<body>
        ...
        <div id="chk-fish1" style="display: none;">
            ...
            <?php foreach ($Foods_list as $foods) : ?>
                <?php if (preg_match("/S1/", $foods->MiddleGenreID)) : ?>
                    <label class="form-check-label"><input class="form-check-input" class="form-check-input" class="form-check-input" type="checkbox" name="food[]" id=<?= $foods->SyokuID ?> value=<?= $foods->SyokuName ?>><?= $foods->SyokuName ?></label>
                <?php endif; ?>
            <?php endforeach ?>
            <br>
        </div>
    ...
    <div class=toroku>
    <input type="submit" name="add" class="button" value="追加"><br>
    </div>
    ...
    <div class="footer">
            ...
            <input type="submit" name="Resist" class="button" value="登録">
    </form>
    </div>
    </div>
</body>
